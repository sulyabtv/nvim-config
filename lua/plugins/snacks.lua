...
vim.keymap.set('n', '<leader>fb', function() Snacks.picker.lines() end, { desc = 'Find in buffer' })
...
vim.keymap.set('n', '<leader>gl', function() Snacks.lazygit.log { cwd = file_dir() } end, { desc = 'Lazygit Reflog' })
...
vim.keymap.set('n', '<leader>lD', function() Snacks.picker.diagnostics() end, { desc = 'Diagnostics (workspace)' })
...
-- history
vim.keymap.set('n', '<leader>:', function() Snacks.picker.command_history() end, { desc = 'Show command history' })
vim.keymap.set('n', '<leader>hn', function() Snacks.notifier.show_history() end, { desc = 'Show notification history' })
...
vim.keymap.set('n', '<leader>pu', function() Snacks.picker.undo() end, { desc = 'Undo history' })
